...
declare function BOX2D_CreateBody_Box(x: number, y: number, width: number, height: number, isStatic: boolean, density: number, friction: number, restitution: number): any;
declare function BOX2D_CreateBody_Ball(x: number, y: number, radius: number, isStatic: boolean, density: number, friction: number, restitution: number): any;
declare function BOX2D_CreateBody_Tri(x1: number, y1: number, x2: number, y2: number, x3: number, y3: number, isStatic: boolean, density: number, friction: number, restitution: number): any;
