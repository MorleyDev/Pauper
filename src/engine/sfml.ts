...
type SfmlEvent
	= { readonly type: SfmlEventType.Closed | SfmlEventType.Resized | SfmlEventType.LostFocus | SfmlEventType.GainedFocus | SfmlEventType.MouseEntered | SfmlEventType.MouseLeft }
	| { readonly type: SfmlEventType.TextEntered | SfmlEventType.KeyPressed | SfmlEventType.KeyReleased; readonly key: Key }
	| { readonly type: SfmlEventType.MouseWheelScrolled; readonly delta: number }
	| { readonly type: SfmlEventType.MouseButtonPressed | SfmlEventType.MouseButtonReleased; readonly button: MouseButton; readonly position: Point2 }
	| { readonly type: SfmlEventType.MouseMoved; readonly position: Point2 };
